import { compileRanges, ipAllowed, makeIpAllowlistMiddleware, } from "./ip-access.js";
...
describe(".isAllowed", () => {
    ...
    describe("IPv6 addresses", () => {
        ...
        it("should handle IPv6 CIDR ranges", () => {
            ...
            const compiled = compileRanges(ranges);
            expect(ipAllowed("2001:db8::1", compiled)).toBe(true);
            expect(ipAllowed("2001:db8:ffff:ffff:ffff:ffff:ffff:ffff", compiled)).toBe(true);
            expect(ipAllowed("2001:db9::1", compiled)).toBe(false);
...
//# sourceMappingURL=ip-access.test.js.map