import { decryptJson, encryptJson, decryptInitiation, encryptInitiation, } from "./target-server-crypto.js";
...
describe("encryptJson / decryptJson", () => {
    ...
    it("throws on truncated ciphertext (only 2 segments)", () => {
        ...
        expect(() => decryptJson(parts.slice(0, 2).join("."), TEST_KEY)).toThrow("Invalid encrypted format");
    });
    it("throws on extra segment (4 parts)", () => {
        const encrypted = encryptJson({ x: 1 }, TEST_KEY);
        expect(() => decryptJson(encrypted + ".extra", TEST_KEY)).toThrow("Invalid encrypted format");
    });
...
//# sourceMappingURL=target-server-crypto.test.js.map