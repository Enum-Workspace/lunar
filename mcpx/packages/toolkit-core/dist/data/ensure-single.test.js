...
describe("ensureSingle", () => {
    ...
    it("should return first element and warn once when multiple items exist", () => {
        ...
        expect(mockWarn).toHaveBeenCalledWith("Multiple active setup found when only one was expected", { count: 3, resourceName: "active setup" });
    });
    ...
    it("should filter by predicate and return matching item", () => {
        const ensure = ensureSingle(noOpLogger, "active item", (item) => item.active);
        const items = [
            { id: "1", active: false },
            { id: "2", active: true },
            { id: "3", active: false },
    ...
    it("should warn when multiple items match predicate", () => {
        const mockWarn = jest.fn();
        const mockLogger = { warn: mockWarn };
        const ensure = ensureSingle(mockLogger, "active setup", (item) => item.active);
        const items = [
            { id: "1", active: true },
            { id: "2", active: true },
            { id: "3", active: false },
...
//# sourceMappingURL=ensure-single.test.js.map