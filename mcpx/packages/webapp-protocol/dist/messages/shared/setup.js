...
import { authSchema, permissionsSchema, skillsConfigSchema, staticOAuthSchema, targetServerAttributesSchema, toolExtensionsSchema, AllowedCommands, } from "@mcpx/shared-model";
...
export const targetServerStreamableHttpSchema = remoteTargetServerSchema.extend({ type: z.literal("streamable-http") });
export const targetServerSchema = z.union([
    targetServerStdioSchema,
    targetServerSseSchema,
    targetServerStreamableHttpSchema,
]);
export const targetServersRecordSchema = z.record(z.string(), targetServerSchema);
...
export const normalizedToolGroupSchema = z.array(z.object({
    name: z.string(),
