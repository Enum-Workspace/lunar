...
import { permissionsSchema, staticOAuthSchema, targetServerAttributesSchema, toolExtensionsSchema, } from "../config/next-version.js";
...
export const savedSetupItemSchema = z.object({
    ...
    targetServers: z.record(z.string(), z.object({
